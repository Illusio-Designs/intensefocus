...
import { getCartItems, removeFromCart, updateCartQuantity, registerCartListener } from '../services/cartService';
import { showRemoveFromCartSuccess, showPlaceOrderSuccess, showCartUpdateSuccess } from '../services/notificationService';
                  ...
                  <div key={item.id} className="cart-item">
                    ...
                    <div className="item-qty">
                      <div className="quantity-selector-cart">
                        ...
                        >-</button>
                        <span className="qty-number-cart">{String(item.quantity).padStart(2, '0')}</span>
                        <button 
                    ...
                    <div className="item-subtotal">
                      {formatPrice(parseFloat(item.whp.replace(/[₹,]/g, '')) * item.quantity)}
                    </div>
          ...
          <div className="summary-section">
            ...
            <div className="summary-breakdown">
              <div className="breakdown-item">
                ...
                <span className="breakdown-value">{formatPrice(calculateSubtotal())}</span>
              </div>
              <div className="breakdown-item">
                <span className="breakdown-label">Tax:</span>
                <span className="breakdown-value">{formatPrice(calculateTax())}</span>
              </div>
              <div className="breakdown-item total">
                <span className="breakdown-label">Total:</span>
                <span className="breakdown-value">{formatPrice(calculateTotal())}</span>
              </div>
            </div>
